...
function AccessNav({icon,title,onClick,navTextClass,changePositionClass}:acessIcon){
    return(
      
        <div className="nav">
            <div id="father-nav-div">
            <div className="nav-div">
              <div className="nav-div-inner">
                <div className="nav-icon-div">{icon}</div>
                <div className="nav-text-div"><p className={navTextClass}>{title}</p></div>
              </div>
            </div>
            <div id="outer1">
                <div>
                ...
                <div id="outer" onClick={onClick} className={changePositionClass}>
                  <div id="inner"></div>
                </div>
